...
Page({
  ...
  data: {
    ...
    year2017: [{ p: '北京卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '天津卷', tail: '' }, { p: '新课标III卷', tail: '' }, { p: '新课标II卷', tail: '' }, { p: '新课标I卷', tail: '' }],
  ...
  setUrl: function (province) {
    ...
    if (yearNum == '2010') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2010/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2011') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2011/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2012') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2012/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2013') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2013/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2014') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2014/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2015') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2015/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2016') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2016/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2017') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2017/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2018') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/物理/2018/' + TOAcn + province +'.pdf'
    }
    return url
  },
  ...
  onLoad: function (options) {
    ...
    if (options.TOA == 'answer')
      this.navigatorTitle(options.year + '年物理真题答案')
    else
      this.navigatorTitle(options.year + '年物理真题')
  },
