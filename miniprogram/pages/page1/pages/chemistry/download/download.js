...
Page({
  ...
  data: {
    ...
    year2013: [{ p: '安徽卷', tail: '' }, { p: '北京卷', tail: '' }, { p: '大纲全国卷', tail: '' }, { p: '福建卷', tail: '' }, { p: '广东卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '山东卷', tail: '' }, { p: '上海卷', tail: '' }, { p: '四川卷', tail: '' }, { p: '天津卷', tail: '' }, { p: '新课标I卷', tail: '' }, { p: '新课标II卷', tail: '' }, { p: '浙江卷', tail: '' }, { p: '重庆卷', tail: '' }],

    year2014: [{ p: '安徽卷', tail: '' }, { p: '北京卷', tail: '' }, { p: '大纲全国卷', tail: '' }, { p: '福建卷', tail: '' }, { p: '广东卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '山东卷', tail: '' }, { p: '上海卷', tail: '' }, { p: '四川卷', tail: '' }, { p: '天津卷', tail: '' }, { p: '新课标I卷', tail: '' }, { p: '新课标II卷', tail: '' }, { p: '浙江卷', tail: '' }, { p: '重庆卷', tail: '' }],
    ...
    year2016: [{ p: '北京卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '四川卷', tail: '' }, { p: '天津卷', tail: '' }, { p: '新课标III丙卷', tail: '' }, { p: '新课标II甲卷', tail: '' }, { p: '新课标I乙卷', tail: '' }, { p: '浙江卷', tail: '' }],

    year2017: [{ p: '北京卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '天津卷', tail: '' }, { p: '新课标III丙卷', tail: '' }, { p: '新课标II甲卷', tail: '' }, { p: '新课标I乙卷', tail: '' }],

    year2018: [{ p: '4月浙江省新选考科目', tail: '' }, { p: '北京卷', tail: '' }, { p: '江苏卷', tail: '' }, { p: '全国卷I', tail: '' }, { p: '全国卷II', tail: '' }, { p: '全国卷III', tail: '' }, { p: '天津卷', tail: '' },],
  },
  ...
  setUrl: function (province) {
    ...
    if (yearNum == '2010') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2010/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2011') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2011/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2012') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2012/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2013') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2013/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2014') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2014/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2015') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2015/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2016') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2016/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2017') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2017/' + TOAcn + province +'.pdf'
    }
    if (yearNum == '2018') {
      url = 'https://6761-gaokaoshiti-d64046-1258198575.tcb.qcloud.la/理化生/化学/2018/' + TOAcn + province +'.pdf'
    }
    console.log('url: '+url)
    return url
  },
  ...
  onLoad: function (options) {
    ...
    if (options.TOA == 'answer')
      this.navigatorTitle(options.year + '年化学答案')
    else
      this.navigatorTitle(options.year + '年化学真题')
  },
